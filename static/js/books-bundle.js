...
window.SUREADING_DATA = {
  ...
  "chapters": {
    ...
    "HP001_questions_ai.json": {
  "bookId": "HP001",
  "totalChapters": 8,
  "generatedAt": "2025-07-11 01:52:16",
  "level": "level5",
  "chapters": {
    "0": {
      ...
      "questions": [
        {
          "question": "According to the story 'Harry Potter and the Philosopher's Stone', where does the main character live?",
          "options": [
            "In a big city",
            "In a small village",
            "Near the ocean",
          ...
          "answer": 1,
          "explanation": "텍스트에서 직접 언급된 정보를 찾는 문제입니다.",
          "difficulty": "easy",
          "type": "literal"
        },
        {
        ...
        {
          "question": "How does the main character in 'Harry Potter and the Philosopher's Stone' probably feel at the end?",
          "options": [
        ...
        {
          "question": "What is the main theme of 'Harry Potter and the Philosopher's Stone'?",
          "options": [
        ...
        {
          "question": "What lesson can we learn from 'Harry Potter and the Philosopher's Stone'?",
          "options": [
  ...
  "chapters": {
    ...
    "MTH001_questions_ai.json": {
  "bookId": "MTH001",
  "totalChapters": 5,
  "generatedAt": "2025-07-11 01:51:36",
  "level": "level2",
  "chapters": {
    "0": {
      "chapterTitle": "Chapter 1",
      ...
      "questions": [
        {
          "question": "In 'Math Adventure Island', what does the word 'adventure' most likely mean?",
          "options": [
            "A dangerous journey",
        ...
        {
          "question": "According to the story 'Math Adventure Island', where does the main character live?",
          "options": [
            "In a big city",
            "In a small village",
            "Near the ocean",
  ...
  "chapters": {
    ...
    "PP001_questions_ai.json": {
  "bookId": "PP001",
  "totalChapters": 3,
  "generatedAt": "2025-07-11 01:51:21",
  "level": "level1",
  "chapters": {
    "0": {
      "chapterTitle": "Chapter 1",
      ...
      "questions": [
        {
          "question": "In 'Peppa Pig - Muddy Puddles', what does the word 'adventure' most likely mean?",
          "options": [
            "A dangerous journey",
            "An exciting experience",
            "A boring day",
        ...
        {
          "question": "According to the story 'Peppa Pig - Muddy Puddles', where does the main character live?",
          "options": [
            "In a big city",
            "In a small village",
            "Near the ocean",
